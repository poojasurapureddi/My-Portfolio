...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xpwyvaea', {
        method: 'POST',
        headers: {
  ...
  const contactInfo = [
    {
      icon: <Mail size={24} />,
      title: 'Email',
      content: 'spooja2511@gmail.com',
      link: 'mailto:spooja2511@gmail.com',
    },
    {
      icon: <Phone size={24} />,
      title: 'Phone',
      content: '+91 9494548375',
      link: 'tel:+91 9494548375',
    },
    {
      icon: <MapPin size={24} />,
      title: 'Location',
